...
//  ------ Use the exact same way of reversing a singly linked list is fine ------
// DoublyLinkedListNode *reverse(DoublyLinkedListNode *llist)
// {
//     DoublyLinkedListNode *curr{llist}, *prev{}, *next{};
...
DoublyLinkedListNode *reverse(DoublyLinkedListNode *llist)
{
    ...
    while (curr)
    {
        ...
        llist = curr; // Update new head
        curr = curr->prev;
    }

    return llist; // New head of reversed list
}
