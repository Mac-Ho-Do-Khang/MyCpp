...
{
    // If all tower are of height 1, player 1 cannot move at all -> player 2 wins
    // If the number of tower is even, whatever move made by player 1 can also be made by player 2 -> player 2 wins
    // Player 1 wins every other cases
    if (m == 1 || n % 2 == 0)
        return 2;
    else
        return 1;
